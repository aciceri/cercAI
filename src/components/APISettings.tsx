        ...
        <div className="settings-modal">
          <div className="settings-content">
            ...
            <div className="provider-tabs">
              ...
              >
                <div className="provider-tab-content">
                  ...
                  <div className="provider-status">
                    <span
                      className={`status-indicator ${getProviderStatus("openrouter")}`}
                    ></span>
                    {getProviderStatus("openrouter") === "active" && (
              ...
              >
                <div className="provider-tab-content">
                  ...
                  <div className="provider-status">
                    <span
                      className={`status-indicator ${getProviderStatus("openai")}`}
                    ></span>
                    {getProviderStatus("openai") === "active" && (
                      <span className="status-text">ACTIVE</span>
                    )}
                ...
                <div>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleModelChange("openrouter", e.target.value)
                      }
                    >
                ...
                <div>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleModelChange("openai", e.target.value)
                      }
                    >
            ...
            <div className="settings-footer">
              <p className="note">
                API keys are stored only locally in your browser and are never
